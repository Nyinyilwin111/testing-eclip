                    ...
                    <div class="trending__product">
                        ...
                        <div class="row">
                        	...
                        	<div id="filterPanel" class="col-lg-12" style="display: none;">
                        		<form method="post" action="${pageContext.request.contextPath}/filterForm">
                        	...
                        	<c:forEach var="movie" items="${movies}">
	                            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 d-flex align-items-stretch">
	                                <div class="product__item w-100">
	                                	<img src="${pageContext.request.contextPath}/proxy-image/${movie.poster_url}" 
	                                    ...
	                                    <div class="product__item__text">
	                                        ...
	                                        <h5><a href="${pageContext.request.contextPath}/anime-details/${movie.movie_id}">${movie.title}</a></h5>
	                                    </div>
	                                </div>
	                            </div>
                            </c:forEach>
                            ...
                            <div class="pagination">
                            	...
                            	<!-- Previous Button -->
                            		<c:choose>
							            ...
							            <c:otherwise>
							                <form method="get" action="${pageContext.request.contextPath}/viewAllMovies">
							                    <input type="hidden" name="page" value="${page - 1}" />
							                    <button type="submit">&#8592; Prev</button>
							                </form>
							            </c:otherwise>
                            	...
                            	<c:forEach begin="1" end="${maxPages}" var="i">
								    <c:choose>
							            <c:when test="${not empty selectedGenres or not empty selectedYear}">
							                <form method="post" action="${pageContext.request.contextPath}/filterForm" style="display:inline;">
							                    <c:forEach var="g" items="${selectedGenres}">
							                        <input type="hidden" name="genre" value="${g}" />
							                    </c:forEach>
							                    <input type="hidden" name="year" value="${selectedYear}" />
							            ...
							            <c:otherwise>
							                <form method="get" action="${pageContext.request.contextPath}/viewAllMovies" style="display:inline;">
							                    <input type="hidden" name="page" value="${i}" />
							                    <button type="submit" <c:if test="${i == page}">class="active"</c:if>>${i}</button>
							                </form>
							            </c:otherwise>
