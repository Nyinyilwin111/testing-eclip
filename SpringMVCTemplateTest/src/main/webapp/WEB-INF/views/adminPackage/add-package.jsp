...
<body>
    <div class="admin-container">
        <div class="admin-header">
            <h1 class="admin-title">Add New Subscription Package</h1>
        </div>
        
        <div class="form-container">
            <form:form method="POST" action="${pageContext.request.contextPath}/AdminPackageAddSave" modelAttribute="pkg">
