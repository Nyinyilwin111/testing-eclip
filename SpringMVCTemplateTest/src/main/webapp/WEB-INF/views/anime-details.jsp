    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="${pageContext.request.contextPath}/proxy-image/${movie.poster_url}" >
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            ...
                                            <li><span>Genre:</span> ${genre.genre_name}</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Rating:</span> ${movie.rating} /10</li>
                                            <li><span>Duration:</span> ${movie.duration_minutes} min</li>
                                            <li><span>Cast:</span> ${casts.cast_names}</li>
                                            <li><span>Director:</span> ${casts.director_name}</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="anime__details__btn">
                                ...
                                <a href="${pageContext.request.contextPath}/anime-watching/${movie.movie_id}" class="watch-btn"><span>Watch Now</span> <i
                    ...
                    <div class="anime__details__review">
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-1.jpg' />" alt="">
                            </div>
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-2.jpg' />" alt="">
                            </div>
                            <div class="anime__review__item__text">
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-3.jpg' />" alt="">
                            </div>
                            <div class="anime__review__item__text">
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-4.jpg' />" alt="">
                            </div>
                            <div class="anime__review__item__text">
                                <h6>Chris Curry - <span>1 Hour ago</span></h6>
                                <p>whachikan Just noticed that someone categorized this as belonging to the genre
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-5.jpg' />" alt="">
                            </div>
                            <div class="anime__review__item__text">
                                <h6>Lewis Mann - <span>5 Hour ago</span></h6>
                                <p>Finally it came out ages ago</p>
                        ...
                        <div class="anime__review__item">
                            <div class="anime__review__item__pic">
                                <img src="<c:url value='/resources/img/anime/review-6.jpg' />" alt="">
                            </div>
                            <div class="anime__review__item__text">
                                <h6>Louis Tyler - <span>20 Hour ago</span></h6>
                                <p>Where is the episode 15 ? Slow update! Tch</p>
